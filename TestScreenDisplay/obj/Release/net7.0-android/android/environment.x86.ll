...
@__DSOCacheEntry_name.12 = internal constant [32 x i8] c"libaot-TestScreenDisplay.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 12
	%struct.DSOCacheEntry {
		i64 162816180, ; hash 0x9b460b4, from name: libaot-TestScreenDisplay
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 13
	%struct.DSOCacheEntry {
	...
	; 110
	%struct.DSOCacheEntry {
		i64 1091097311, ; hash 0x4108d2df, from name: aot-TestScreenDisplay.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 111
	%struct.DSOCacheEntry {
		i64 1092193158, ; hash 0x41198b86, from name: libaot-TestScreenDisplay.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 195
	%struct.DSOCacheEntry {
		i64 1909835524, ; hash 0x71d5c704, from name: TestScreenDisplay
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 209
	%struct.DSOCacheEntry {
		i64 2002473133, ; hash 0x775b50ad, from name: TestScreenDisplay.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 344
	%struct.DSOCacheEntry {
		i64 3089599356, ; hash 0xb8278b7c, from name: aot-TestScreenDisplay
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
