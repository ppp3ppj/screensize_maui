...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"9f440482-8e09-4752-82e4-50ea3775c304\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [34 x i8] c"com.companyname.testscreendisplay\00", align 16
...
@__DSOCacheEntry_name.57 = internal constant [32 x i8] c"libaot-TestScreenDisplay.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 91
	%struct.DSOCacheEntry {
		i64 3776983481528092563, ; hash 0x346a8a7713000793, from name: libaot-TestScreenDisplay.dll.so
		i8 0, ; ignore
	...
	; 269
	%struct.DSOCacheEntry {
		i64 11397593236864991757, ; hash 0x9e2c62a971bb820d, from name: libaot-TestScreenDisplay
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.57, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 270
	%struct.DSOCacheEntry {
		i64 11402846298614166981, ; hash 0x9e3f0c4b314675c5, from name: TestScreenDisplay
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.57, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 435
	%struct.DSOCacheEntry {
		i64 17826586005365297453, ; hash 0xf764c185c7bf912d, from name: aot-TestScreenDisplay.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.57, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 438
	%struct.DSOCacheEntry {
		i64 18016392720625776329, ; hash 0xfa0715b976d536c9, from name: TestScreenDisplay.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.57, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 441
	%struct.DSOCacheEntry {
		i64 18042831152583299553, ; hash 0xfa650356981451e1, from name: aot-TestScreenDisplay
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.57, i32 0, i32 0), ; name
		i8* null; handle
	}, 
